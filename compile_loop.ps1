...
foreach ($file in $sources) {
    ...
    $p = Start-Process -FilePath "$java_home\bin\javac.exe" -ArgumentList "-d", $classes_dir, "-cp", $classpath, $file.FullName -Wait -NoNewWindow -PassThru
