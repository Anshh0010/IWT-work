...
Write-Host "Compiling with PowerShell..." -ForegroundColor Cyan
...
$sources | Set-Content -Path "sources_ps.txt" -Encoding Ascii

# Compile
$javac = "$java_home\bin\javac.exe"
$args = @("-d", $classes_dir, "-cp", $classpath, "@sources_ps.txt")
